    ...
    <div class="row">
        <div class="col col-md-12">
            <div class="jumbotron">
                ...
                <div class="row mt-5">
                <p class="lead">A linguagem adotada pela plataforma para a escrita do contrato inteligente constitui um ponto de extrema relevância, uma vez que algumas redes desenvolvem suas próprias linguagens, o que acaba por aumentar a curva de aprendizagem.</p>
                </div>
            </div>
        </div>
    </div>
